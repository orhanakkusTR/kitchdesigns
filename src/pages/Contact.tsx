...
import { formatPhoneNumber, getUnformattedPhone } from '../lib/formatPhone';
...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const unformattedPhone = getUnformattedPhone(formData.phone);
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        keywords="contact Kitch Designs, free quote Cherry Hill, kitchen remodeling consultation, visit showroom, schedule appointment"
      />
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <a href="https://maps.app.goo.gl/N27zQRpgG5AQzHtMA" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">
                            1641 Marlton Pike Unit 100, Cherry Hill Township, NJ 08034
                          </a>
