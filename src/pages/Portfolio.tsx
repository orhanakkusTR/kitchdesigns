...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Our Portfolio - Kitchen & Bathroom Transformations | Kitch Designs"
        description="Explore our portfolio of completed kitchen and bathroom remodeling projects in Cherry Hill and South Jersey. See our craftsmanship and design expertise."
        canonicalUrl="https://kitchdesigns.com/portfolio"
        keywords="remodeling portfolio, completed projects, kitchen transformations, bathroom renovations, South Jersey projects"
        ogImage="https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?auto=compress&cs=tinysrgb&w=1920"
      />
