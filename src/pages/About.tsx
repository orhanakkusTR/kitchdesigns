...
export default function About() {
  ...
  return (
    <div className="min-h-screen">
      ...
      />
      <section className="relative min-h-[70vh] md:min-h-[75vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden pt-20 md:pt-0">
        ...
        <div className="relative z-20 container mx-auto px-6 py-12 md:py-0 text-white">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-16 md:mb-0 animate-slide-up-delay-2">
              <button
