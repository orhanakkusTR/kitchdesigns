...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        title="Privacy Policy - Kitch Designs"
        description="Privacy Policy for Kitch Design Studio. Learn how we collect, use, and protect your personal information."
        canonicalUrl="https://kitchdesigns.com/privacy-policy"
      />
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Kitch Design Studio ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
            </div>
