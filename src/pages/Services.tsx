  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        keywords="kitchen remodeling Cherry Hill, bathroom renovation, custom cabinets, flooring installation, countertop installation, tile work, home renovation services"
        ogImage="https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Kitchen-Remodeling.jpg"
      />
      ...
      <section className="relative min-h-[65vh] md:min-h-[75vh] flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/servis-hero-kc.jpg')"
          }}
        ></div>
