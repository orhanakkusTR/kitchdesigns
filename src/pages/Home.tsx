...
import { ChevronRight, Star, Award, Users, Clock, CheckCircle2, ArrowRight, Sparkles, X } from 'lucide-react';
...
export default function Home() {
  ...
  const videos = [
    {
      id: 0,
      embedUrl: 'https://www.youtube.com/embed/Jt2X2A2XArk',
      title: 'Client Testimonial 1'
    },
    {
      id: 1,
      embedUrl: 'https://www.youtube.com/embed/2LxA472wO_Y',
      title: 'Visit Our Showroom | KitchDesign'
    },
    {
      id: 2,
      embedUrl: 'https://www.youtube.com/embed/vZU0it6Yk3U',
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-0">
        ...
        <div className="relative z-20 container mx-auto px-6 py-12 md:py-0 text-white">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-primary/20 backdrop-blur-sm border border-primary/30 px-3 py-2 rounded-full mb-6 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-24 md:mb-32 lg:mb-40 animate-slide-up-delay-2">
              <button
        ...
        <div className="absolute bottom-0 left-0 right-0 z-20 bg-gradient-to-t from-black/70 to-transparent py-6 md:py-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
              {[
                ...
                <div key={index} className="text-center text-white">
                  ...
                  <div className="text-xl md:text-2xl lg:text-3xl font-bold mb-1">{stat.label}</div>
                  <div className="text-xs md:text-sm text-gray-300">{stat.sub}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 md:mb-16">
            <span className="text-primary font-semibold text-xs sm:text-sm uppercase tracking-wider">Video Testimonials</span>
          ...
          <div className="max-w-6xl mx-auto mb-16">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-gray-900 aspect-video mb-8">
              <iframe
                src={`https://www.youtube.com/embed/${videos[activeVideo].embedUrl.split('/').pop()}?rel=0&modestbranding=1`}
      ...
      <section className="py-12 md:py-16 bg-white overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-8">
            <span className="text-primary font-semibold text-xs sm:text-sm uppercase tracking-wider">Trusted Partners</span>
