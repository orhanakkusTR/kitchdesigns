  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        ogImage="https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/hero-2-kd.jpg"
      />
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden pt-20 md:pt-0">
        ...
        <img
          src="https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/hero-2-kd.jpg"
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <div className="space-y-3 md:space-y-4">
                  <img
                    src="https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-1.png"
                    alt="Kitchen design"
                    width="600"
                    height="400"
                  ...
                  />
                  <img
                    src="https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-2.png"
                    alt="Cabinet design"
                    width="600"
                    height="800"
                ...
                <div className="space-y-3 md:space-y-4 pt-6 md:pt-8">
                  <img
                    src="https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-3.png"
                    alt="Bathroom design"
                    width="600"
                    height="800"
                    className="rounded-xl md:rounded-2xl shadow-xl w-full h-56 sm:h-64 md:h-80 object-cover hover:scale-105 transition-transform duration-500"
                  ...
                  <div className="relative">
                    <img
                      src="https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-4.png"
                      alt="Countertop"
                      width="600"
                      height="400"
                      className="rounded-xl md:rounded-2xl shadow-xl w-full h-48 sm:h-56 md:h-64 object-cover hover:scale-105 transition-transform duration-500"
            ...
            {[
              {
                ...
                image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Kitchen-Remodeling.jpg'
              },
              {
                title: 'Bathroom Remodeling',
                description: 'Create your personal spa retreat with elegant fixtures.',
                image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Bathroom-Remodeling.jpg'
              },
              {
                title: 'Custom Cabinets',
                description: 'Handcrafted cabinetry designed to maximize space.',
                image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Custom-Cabinets.jpg'
              },
              {
                title: 'Countertops',
                description: 'Premium materials including granite, quartz, and marble.',
                image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Countertops-2.jpg'
              },
              {
                title: 'Flooring',
                description: 'Beautiful, durable flooring to complete your space.',
                image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Flooring.jpg'
              },
              {
                title: 'Full Home Renovation',
                description: 'Complete home transformations from concept to completion.',
                image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Full-Home-Renovation.jpg'
              }
            ].map((service, index) => (
              <div
                key={index}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mb-12 overflow-hidden">
            <div className="flex items-center gap-12 md:gap-16 animate-scroll-brands">
              {[
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-1.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-2.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-3.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-4.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-5.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-6.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-1.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-2.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-3.webp',
                'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/m-4.webp',
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-8">
            {[
              'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-1.png',
              'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-2.png',
              'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-3.png',
              'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-4.png',
              'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/k-5.png',
              'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Flooring.jpg'
            ].map((image, index) => (
              <button
                key={index}
