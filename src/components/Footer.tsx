        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="bg-gray-100 p-3 rounded-lg hover:bg-primary hover:text-white transition-colors duration-300">
                <Facebook size={20} />
              </a>
              <a href="#" className="bg-gray-100 p-3 rounded-lg hover:bg-primary hover:text-white transition-colors duration-300">
                <Instagram size={20} />
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-600">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:8563983087" className="hover:text-primary transition-colors">
                  856-398-3087
                </a>
              </li>
              <li className="flex items-start gap-3">
